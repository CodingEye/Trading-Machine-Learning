...
//|                                                                  |
//+------------------------------------------------------------------+
bool CGRU::Init(string onnx_filename, uint flags=ONNX_DEFAULT)
 {
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CGRU::Init(const uchar &onnx_buff[], ulong flags=ONNX_DEFAULT)
 {
  Print("Initilaizing ONNX model..."); 
...
void CGRU::PrintTypeInfo(const long num,const string layer,const OnnxTypeInfo& type_info)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
int CGRU::predict_bin(const matrix &x, const vector &classes_in_data)
 {
   if (!this.initialized)
    {
...
//|                                                                  |
//+------------------------------------------------------------------+
vector CGRU::predict_proba(const matrix &x)
 {
...
//|                                                                  |
//+------------------------------------------------------------------+
double CGRU::predict(const matrix &x)
 {
   if (!this.initialized)
    {
      printf("%s The model is not initialized yet to make predictions | call Init function first",__FUNCTION__);
...
//|                                                                  |
//+------------------------------------------------------------------+
string CGRU::ConvertTime(double seconds)
{
    string time_str = "";
